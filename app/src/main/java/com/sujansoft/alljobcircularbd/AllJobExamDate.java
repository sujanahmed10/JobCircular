...
public class AllJobExamDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_job_exam_date);
        ...
        web.loadUrl("https://studyonlinebd.com/user/all-jobs-exam-date/");
