...
public class CholomanGoveJob extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choloman_gove_job);
        ...
        web.loadUrl("https://www.banglacyber.com/ongoing-all-government-job-circular/");
