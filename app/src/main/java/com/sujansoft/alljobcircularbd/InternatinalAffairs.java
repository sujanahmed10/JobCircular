...
public class InternatinalAffairs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.internatinal_affairs);
        ...
        web.loadUrl("https://jobtestbd.com/international-affairs/");
