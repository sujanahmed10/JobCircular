...
public class GoveDateOver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gove_date_over);
        ...
        web.loadUrl("https://alljobs.teletalk.com.bd/bn/jobs/govt/deadline-today/");
